...
<title>StrainGage管理系统-主页面</title>
<%
	// 权限验证
...
<div region="north" style="height: 78px;background-color: #E0ECFF">
 <table width="100%" style="padding: 5px;">
 	<tr>
 		<td width="50%">
 			<img width="70%" height="60px" alt="StrainGage" src="${pageContext.request.contextPath }/images/logo1.png"/>
 		</td>
 		<td valign="bottom" align="right" width="50%">
 			<font size="3">&nbsp;&nbsp;<strong>欢迎：${currentMemberShip.user.id }(${currentMemberShip.user.firstName })【${currentMemberShip.group.name}】</strong></font><%-- ${currentMemberShip.user.id }(${currentMemberShip.user.firstName }${currentMemberShip.user.lastName })【${currentMemberShip.group.name}】 --%>
 		</td>
 	</tr>
 </table>
</div>
<div region="center" >
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px;"><font color="#009ad6" size="10">欢迎使用</font></div>
		</div>
	</div>
</div>
	...
	<div class="easyui-accordion" data-options="fit:true,border:false">
	    <%-- <c:if test="${currentMemberShip.group.name=='管理员' }">  --%>
			...
			<div title="业务管理"  data-options="iconCls:'icon-yewu'" style="padding:10px">
				<a href="javascript:openTab('StrainGage申请','applyManage.jsp','icon-apply')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-apply'" style="width: 150px">StrainGage申请</a>
			</div>
			...
			<%-- </c:if>  
		    <c:if test="${currentMemberShip.group.name=='测试工程师' || currentMemberShip.group.name=='审核课级主管' ||currentMemberShip.group.name=='审核部级主管'}">--%>
			<div title="测试时间排配"  data-options="iconCls:'icon-date'" style="padding:10px;">
				<a href="javascript:openTab('排配管理','ArrangeManage.jsp','icon-check')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-check'" style="width: 150px;">排配管理</a>
				<a href="javascript:openTab('历史排配管理','ArrangeResManage.jsp','icon-history')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-history'" style="width: 150px;">历史排配管理</a>
			</div>
			<div title="测试文档管理"  data-options="iconCls:'icon-fwgd'" style="padding:10px;">
				<a href="javascript:openTab('测试文档管理','fileManage.jsp','icon-file')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-file'" style="width: 150px;">测试文档管理</a>
			</div>
			<div title="费用转架管理"  data-options="iconCls:'icon-transport'" style="padding:10px">
				<a href="javascript:openTab('费用转架管理','costTransformManage.jsp','icon-swap')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-swap'" style="width: 150px">费用转架管理</a>
			</div>
			<%-- </c:if>  --%>
