...
<script>
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/straingage/getStrainGageById.do",{STRAINID:'${param.STRAINID}'},function(result){
...
<div id="p" class="easyui-panel" title="签核详情" style="width: 830px;height: auto;padding: 10px">
...
<table id="dg" title="批注列表" class="easyui-datagrid" 
  fitColumns="true"
  url="${pageContext.request.contextPath}/task/listHistoryCommentWithProcessInstanceId.do?processInstanceId=${param.processInstanceId}" style="width: 830px;height: 200px;">
 <thead>
 	<tr>
