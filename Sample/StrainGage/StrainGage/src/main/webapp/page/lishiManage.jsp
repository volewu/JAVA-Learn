...
<table id="dg" title="历史任务管理" class="easyui-datagrid"
  ...
  url="${pageContext.request.contextPath}/task/finishedList.do?groupId=${currentMemberShip.group.id}&userId=${currentMemberShip.user.id }" fit="true" toolbar="#tb">
 <thead>
 	<tr>
...
<div id="dlg2" class="easyui-dialog" style="width: 750px;height: 250px;padding: 4px" closed="true" >
  ...
  fitColumns="true"  
  url="${pageContext.request.contextPath}/task/listHistoryComment.do" style="width: 100%;height: 100%;">
 <thead>
 	<tr>
...
<div id="dlg3" class="easyui-dialog" style="width: 750px;height: 350px;padding: 4px" closed="true" >
 
 	<table id="dg3" title="流程执行过程列表" class="easyui-datagrid"
  fitColumns="true"  
  url="${pageContext.request.contextPath}/task/listAction.do" style="width: 100%;height: 100%;">
 <thead>
 	<tr>
