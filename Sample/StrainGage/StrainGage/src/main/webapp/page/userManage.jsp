...
<table id="dg" title="用户管理" class="easyui-datagrid"
 ...
 <thead>
 	<tr>
 		...
 		<th field="rev" width="80" align="center">标记</th>
 		<th field="password" width="80" align="center">密码</th>
 		<th field="firstName" width="50" align="center">姓名</th>
 	...
 	<form id="fm" method="post">
 		<table cellpadding="8px">
 			...
 			<tr>
 				<td>标记：</td>
 				<td>
 					<input type="text" id="rev" name="rev" class="easyui-numberbox" required="true"/>
 				</td>
 				<td></td>
 				<td></td>
 				<td>
