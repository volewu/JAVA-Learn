	...
	<div id="tb">
		...
		<div>
			&nbsp;学号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo"
				...
				data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeCombo'" />
			...
			<table cellspacing="5px;">
				...
				<tr>
					...
					<td><input class="easyui-datebox" name="birthday"
						id="birthday" required="true" editable="false" /></td>
				</tr>
				<tr>
					<td>班级名称：</td>
					<td><input class="easyui-combobox" id="gradeId" name="gradeId"
						data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeCombo'" /></td>
					<td></td>
					<td>Email：</td>
