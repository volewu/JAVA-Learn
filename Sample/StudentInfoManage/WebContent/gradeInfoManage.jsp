...
<body style="margin: 5px">
	...
	<div id="tb">
		<div>
			<a href="javascript:gradeAdd()" class="easyui-linkbutton"
				iconCls="icon-add" plain="true">添加</a> <a
				href="javascript:gradeModify()" class="easyui-linkbutton"
	...
	<div id="dlg-buttons">
		<a href="javascript:gradeSave()" class="easyui-linkbutton"
